...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertquery = " insert into gymnosperm(name, scientific_name, population_trend, red_list, establishment) values ('$name','$scientific_name', '$population_trend', '$red_list' ,'$establishment') ";
...
<html lang="en">
  <head>
    ...
    <title>Gymnosperms data entry</title>
  </head>
  <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/forest/displaygym.php">Table</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/forest/deletegym.php">Delete</a>
      </li>
...
<div class="container my-4">
     <h1 class="text-center">Gymnosperms</h1>
     <form action="/forest/insertgym.php" method="post">
	 ...
	 <form action="displaygym.php" method="post">
             <a center href="displaygym.php" target="_blank" class="btn btn-primary">VIEW TABLE</a>
</form>
