...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertquery = " insert into angiosperm(name, scientific_name, population_trend, red_list, establishment) values ('$name','$scientific_name', '$population_trend', '$red_list' ,'$establishment') ";
...
<html lang="en">
  <head>
    ...
    <title>Angiosperms data entry</title>
  </head>
  <body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/forest/displayang.php">Table</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/forest/deleteang.php">Delete</a>
      </li>
...
<div class="container my-4">
     <h1 class="text-center">Angiosperms</h1>
     <form action="/forest/insertangio.php" method="post">
	 ...
	 <form action="displayang.php" method="post">
             <a center href="displayang.php" target="_blank" class="btn btn-primary">VIEW TABLE</a>
</form>
