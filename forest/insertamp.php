...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertquery = " insert into amphibian(name, scientific_name, population_trend, red_list, establishment) values ('$name','$scientific_name', '$population_trend', '$red_list' ,'$establishment') ";
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/forest/displayamp.php">Table</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/forest/deleteamp.php">Delete</a>
      </li>
...
<div class="container my-4">
     ...
     <form action="/forest/insertamp.php" method="post">
	 ...
	 <form action="displayamp.php" method="post">
             <a center href="displayamp.php" target="_blank" class="btn btn-primary">VIEW TABLE</a>
</form>
