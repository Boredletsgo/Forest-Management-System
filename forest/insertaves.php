...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insertquery = " insert into aves(name, scientific_name, population_trend, red_list, establishment) values ('$name','$scientific_name', '$population_trend', '$red_list' ,'$establishment') ";
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/forest/displayaves.php">Table</a>
      </li>
      <li class="nav-item">
...
<div class="container my-4">
     ...
     <form action="/forest/insertaves.php" method="post">
	 ...
	 <form action="displayaves.php" method="post">
             <a center href="displayaves.php" target="_blank" class="btn btn-primary">VIEW TABLE</a>
</form>
